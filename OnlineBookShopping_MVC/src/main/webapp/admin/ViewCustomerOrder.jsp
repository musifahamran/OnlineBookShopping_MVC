...
<%
	List<Transaction> transactionList = (List<Transaction>)request.getAttribute("customerOrderList");
	
	for(Transaction t1: transactionList){
				out.println("<tr>");
				out.println("<td>"+t1.getTransaction_id()+"</td>");
				out.println("<td>"+t1.getCustomer().getFname()+" "+ t1.getCustomer().getLname()+"</td>");
				out.println("<td>"+t1.getBook().getTitle()+"</td>");
				out.println("<td>"+t1.getBook().getAuthor()+"</td>");
				out.println("<td>"+t1.getBook().getCategory()+"</td>");
